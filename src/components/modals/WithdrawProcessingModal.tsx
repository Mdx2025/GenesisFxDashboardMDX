...
function HourglassIllustration() {
  return (
    <div className="relative w-[280px] h-[280px] mx-auto">
      ...
      {/* Inner hourglass — detailed shape with gradient border */}
...
export function WithdrawProcessingModal({ open, onClose, amount = '60.00', coin = 'USDT' }: WithdrawProcessingModalProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative w-[500px] max-w-[95vw] bg-[#0a0a0a] rounded-[40px] border border-[#064B34] shadow-[0px_9px_37px_0px_rgba(0,0,0,0.30)] backdrop-blur-xl overflow-hidden px-6 py-10 sm:px-10 sm:py-14"
        style={{
          animation: visible
      ...
      >
        ...
        <div className="text-center mt-4">
          <p className="text-[#A0A0A0] text-[24px] font-normal">Withdrawal Processing</p>
        ...
        <div className="flex justify-center mt-8">
          <button
            onClick={() => { onClose(); navigate('/assets-management') }}
        ...
        {/* Bottom glow */}
        <div
          className="absolute left-1/2 -translate-x-1/2 bottom-[-80px] w-[400px] h-72 bg-green-900 rounded-full pointer-events-none"
