      ...
      <div ref={modalRef} className="relative w-[49.5625rem] max-w-[95vw]">
        <GlassCard variant="light" rounded="1.875rem" className="overflow-hidden" style={{ backgroundColor: '#0C1311' }}>
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[1.875rem]" aria-hidden="true">
            <div className="absolute w-[30.8125rem] h-[17.375rem] -left-[11.6875rem] bottom-0 translate-y-[20%] bg-[#064B34] rounded-full" style={{ filter: 'blur(157.15px)' }} />
          ...
          <div className="relative flex flex-col items-center px-[7.1875rem] pt-[7.9375rem] pb-40">
            ...
            <div className="w-[34.125rem] mt-[2.625rem]">
              ...
              <input
                ...
                className="w-full h-[3.125rem] bg-[#0C1311] border border-[#064B34] rounded-[1.875rem] px-[1.625rem] text-white text-base font-acid placeholder:text-[#808080] outline-none focus:border-[#D46356] transition-colors"
              />
            </div>
