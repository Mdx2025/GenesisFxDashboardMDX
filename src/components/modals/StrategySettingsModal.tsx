...
function LockIcon() {
  return (
    <span className="relative block size-6 shrink-0" aria-hidden="true">
      <svg className="absolute left-0.5 top-[1.25px] w-5 h-[20.75px]" viewBox="0 0 20 20.75" fill="none" preserveAspectRatio="none">
        <path fillRule="evenodd" clipRule="evenodd" d="M3.25 8.80461V6.75C3.25 3.02208 6.27208 0 10 0C13.7279 0 16.75 3.02208 16.75 6.75V8.80461C17.8648 8.88786 18.5907 9.09805 19.1213 9.62868C20 10.5074 20 11.9216 20 14.75C20 17.5784 20 18.9926 19.1213 19.8713C18.2426 20.75 16.8284 20.75 14 20.75H6C3.17157 20.75 1.75736 20.75 0.87868 19.8713C0 18.9926 0 17.5784 0 14.75C0 11.9216 0 10.5074 0.87868 9.62868C1.40931 9.09805 2.13525 8.88786 3.25 8.80461ZM4.75 6.75C4.75 3.85051 7.10051 1.5 10 1.5C12.8995 1.5 15.25 3.85051 15.25 6.75V8.75357C14.867 8.75 14.4515 8.75 14 8.75H6C5.54849 8.75 5.13301 8.75 4.75 8.75357V6.75Z" fill="#808080" />
      </svg>
    </span>
  )
}
...
export function StrategySettingsModal({ open, onClose }: StrategySettingsModalProps) {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="relative w-[47.625rem] max-w-[95vw] my-auto max-h-[calc(100dvh-2rem)] flex flex-col bg-gfx-green-800 border-[1.16px] border-gfx-green-800 rounded-[1.75rem] shadow-[0px_4.641px_23.204px_rgba(0,0,0,0.03)]"
        style={{
      ...
      >
        ...
        >
          ...
          {/* Tabs */}
          <div className="mt-[calc(var(--u)*41.5)] relative w-[27.6875rem] h-[2.875rem] rounded-[60px] bg-gfx-green-900">
            <div className="absolute left-0 top-px w-[8.875rem] h-[2.8125rem] rounded-[60px] bg-gfx-green-200 border-[1.35px] border-gfx-green-300" />
            <div className="absolute left-[62px] top-[28px] w-[30px] h-4 rounded-full bg-gfx-green-300/70 blur-[6px] mix-blend-plus-lighter" aria-hidden="true" />
            <button type="button" className="absolute left-0 top-0 h-full w-[142px] flex items-center justify-center gap-[7px]">
              <GearIcon size={16} />
              <span className="font-acid font-medium text-base leading-[24.44px] text-white">General</span>
            </button>
            <button type="button" disabled className="absolute left-[165px] top-0 h-full w-[96px] flex items-center justify-center gap-1.5">
              <EyeIcon />
              <span className="font-acid font-medium text-base leading-[24.44px] text-gfx-neutral-500">Visibility</span>
            </button>
            <button type="button" disabled className="absolute left-[312px] top-0 h-full w-[88px] flex items-center justify-center gap-[7px]">
              <LockIcon />
              <span className="font-acid font-medium text-base leading-[24.44px] text-gfx-neutral-500">Access</span>
            </button>
          </div>
          ...
          <div className="mt-[calc(var(--u)*66)] -mr-0.5 flex items-center justify-end gap-3">
            <SecondaryButton className="w-[12.375rem] !rounded-[1.875rem]" onClick={handleClose}>Cancel</SecondaryButton>
