...
export function TwoFactorModal({ open, onClose }: TwoFactorModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="absolute inset-0 overflow-hidden pointer-events-none bg-[#0C1311] rounded-[1.875rem]"
          aria-hidden="true"
        >
        ...
        <div className="relative flex flex-col items-center px-12 pt-16 pb-12">
          ...
          <div className="flex items-center gap-3 mb-8">
            <div className="h-9 bg-[#09241C] border border-[#064B34] rounded-[0.625rem] flex items-center px-4">
              <span className="text-white text-sm font-acid tracking-wide">EIBIJPZZSOR4JCPXKH4LHEZ5LD476ZZN</span>
            </div>
          ...
          <div className="flex items-center gap-3 mb-10">
            {code.map((digit, i) => (
              <input
                ...
                className="w-[4.28rem] h-[5.035rem] rounded-[0.53rem] border border-[#303030] bg-transparent text-white text-3xl font-acid text-center outline-none focus:border-gfx-green-300 transition-colors"
              />
            ))}
          </div>
