...
function AuthFooter() {
  return (
    <footer className="w-full absolute bottom-0 px-4 lg:pl-15 lg:pr-0">
      <div className="bg-[#0c1311] rounded-xl px-4 lg:px-[1.4375rem] py-3 lg:py-4 flex flex-col sm:flex-row items-center gap-2 sm:gap-[2.5rem]">
