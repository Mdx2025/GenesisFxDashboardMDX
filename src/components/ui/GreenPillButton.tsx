...
export function GreenPillButton({ children, onClick }: GreenPillButtonProps) {
  return (
    ...
    >
      <div
        className="absolute inset-0 rounded-full pointer-events-none border border-gfx-neutral-600 [mask-image:radial-gradient(25%_60%_at_0_10%,#fff,#0000),radial-gradient(25%_60%_at_100%_10%,#fff,#0000)] [-webkit-mask-image:radial-gradient(25%_60%_at_0_10%,#fff,#0000),radial-gradient(25%_60%_at_100%_10%,#fff,#0000)] [mask-composite:add] [-webkit-mask-composite:destination-over]"
        aria-hidden="true"
      />
