...
export function SuccessSnackbar({ open, message = 'Successful Transfer', duration = 4000, onClose }: SuccessSnackbarProps) {
  ...
  return (
    <div
      ref={ref}
      className="fixed z-toast overflow-hidden top-6 right-[1.5rem] w-[24rem] h-[5rem] bg-[rgba(255,255,255,0.05)] rounded-full shadow-[0px_1.25px_0px_1.25px_rgba(255,255,255,0.04)_inset,0px_5.01px_25.07px_rgba(0,0,0,0.20)] outline outline-1 outline-offset-[-1.25px] outline-[rgba(255,255,255,0.05)] backdrop-blur-[25px]"
      role="status"
      aria-live="polite"
    >
      {/* Decorative glows */}
