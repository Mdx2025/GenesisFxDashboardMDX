...
export function PortfolioEquity() {
  return (
    <GlassCard variant="heavy" divider="none" rounded="18px" className="dashboard-primary-card h-full min-h-0 overflow-hidden">
      ...
      <div className="relative z-10 p-4 sm:p-6 flex flex-col h-full">
        <div className="flex items-start justify-between mb-4 flex-wrap gap-3">
          <div>
            <h2 className="text-tab tracking-tab text-gfx-neutral-500 mb-2">Portfolio Equity</h2>
