...
export function PortfolioEquity() {
  return (
    <GlassCard variant="heavy" divider="green" rounded="18px" className="h-full overflow-hidden">
      <div className="absolute w-[400px] h-[200px] -left-[50px] -top-[30px] rounded-full pointer-events-none" style={{ background: '#104030', filter: 'blur(120px)' }} aria-hidden="true" />
      <div className="absolute w-[300px] h-[150px] left-1/2 -translate-x-1/2 -bottom-[30px] rounded-full pointer-events-none" style={{ background: '#104030', filter: 'blur(100px)' }} aria-hidden="true" />
