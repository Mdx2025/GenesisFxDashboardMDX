...
export function QuickActions() {
  return (
    <GlassCard variant="heavy" divider="white" rounded="20px" className="h-full">
      <div className="absolute w-[250px] h-[120px] -right-[10%] -top-[8%] rounded-full pointer-events-none" style={{ background: GLOW_GREEN, filter: 'url(#blur-100)', willChange: 'transform' }} aria-hidden="true" />
