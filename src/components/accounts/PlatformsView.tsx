  ...
  return (
    <div className="flex flex-col gap-3 sm:gap-4">
      {PLATFORMS.map((platform) => (
        <div
          key={platform.name}
          className="platform-card relative flex items-center gap-3 sm:gap-5 px-4 sm:px-6 xl:px-8 py-4 sm:py-6 xl:py-8 rounded-lg bg-gfx-green-800 shadow-md border border-gfx-card-border"
        >
