  ...
  return (
    <div className="flex flex-col gap-3 sm:gap-4">
      {PLATFORMS.map((platform) => (
        <div
          key={platform.name}
          className="relative flex items-center gap-3 sm:gap-5 px-4 sm:px-6 xl:px-8 py-4 sm:py-6 xl:py-8 rounded-[19px] bg-gfx-green-800 shadow-[0px_9.08px_23.2px_rgba(0,0,0,0.2)] border border-[rgba(255,255,255,0.06)]"
        >
          <div className="flex-shrink-0 w-10 h-10 sm:w-[3.6875rem] sm:h-[3.6875rem] rounded-[0.625rem] sm:rounded-[0.75rem] bg-gfx-green-900 flex items-center justify-center">
          ...
          <div className="flex-shrink-0 w-[7.5rem] sm:w-[8.5rem]">
            {platform.action === 'launch' ? (
              ...
              <SparkleButton fullWidth>
                <span className="text-white font-acid font-medium text-sm sm:text-base">Download</span>
              </SparkleButton>
            )}
          </div>
        </div>
