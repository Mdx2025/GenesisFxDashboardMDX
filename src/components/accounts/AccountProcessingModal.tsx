...
interface AccountProcessingModalProps {
  open: boolean
  onClose: () => void
  onComplete?: () => void
}

export function AccountProcessingModal({ open, onClose, onComplete }: AccountProcessingModalProps) {
    ...
    >
      ...
      >
        <svg width="0" height="0" className="absolute">
          <defs>
            <filter id="account-circle-glow" x="-100%" y="-100%" width="300%" height="300%">
