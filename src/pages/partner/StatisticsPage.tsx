      ...
      <div className="relative p-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4 mb-6">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="inline-flex items-center px-5 py-2.5 rounded-[2rem] border border-[#303030] text-white text-[0.875rem] font-acid"><span className="optical-text">Total:$0.00</span></span>
          </div>
