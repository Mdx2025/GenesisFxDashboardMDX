          ...
          <div className="relative px-[1.5625rem] py-[1.4375rem]">
            ...
            <div className="relative z-10 flex items-start gap-[1.375rem]">
              ...
              <div className="flex-1 min-w-0 flex flex-col gap-[0.375rem]">
                ...
                <div className="inline-flex items-center gap-[0.6875rem] px-[0.875rem] py-1 bg-gfx-green-900 rounded-[2rem] border border-[#064B34] w-fit">
                ...
                <div className="flex items-center gap-[1.375rem] text-[#808080] text-[1.019rem] font-acid">
              ...
              <div className="text-right shrink-0 flex flex-col justify-between self-stretch">
                <p className="text-white text-base font-acid font-medium leading-[1.527rem]">Commission Earned</p>
                <p className="text-gfx-green-300 text-[1.5rem] font-acid">$0</p>
                <p className="text-[#A0A0A0] text-sm font-acid leading-[1.175rem]">Bal <span className="ml-1">$0</span></p>
              </div>
            </div>
          </div>
        </GlassCard>
      ...
      <div className="relative p-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4 mb-6">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="inline-flex items-center px-5 py-2.5 rounded-[2rem] border border-[#303030] text-white text-[0.875rem] font-acid"><span className="optical-text optical-text--numeric">Total:$0.00</span></span>
          </div>
