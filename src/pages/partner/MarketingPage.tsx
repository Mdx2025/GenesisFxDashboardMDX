                  ...
                  <div className="p-[2.5rem_2.6rem] flex flex-col gap-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-2 ml-auto">
                        <button type="button" aria-label="Show QR code" className="flex items-center justify-center w-[2.125rem] h-[2.125rem] rounded-full bg-gfx-surface-deep cursor-pointer hover:opacity-80 transition-opacity">
                          <PartnerQrCodeIcon />
                        </button>
                        <button type="button" aria-label="Share link" className="flex items-center justify-center w-[2.125rem] h-[2.125rem] rounded-full bg-gfx-surface-deep cursor-pointer hover:opacity-80 transition-opacity">
                          <PartnerShareIcon />
                        </button>
                        <button type="button" aria-label="Copy link" className="flex items-center justify-center w-[2.125rem] h-[2.125rem] rounded-full bg-gfx-surface-deep cursor-pointer hover:opacity-80 transition-opacity">
                          <PartnerCopyIcon />
                        </button>
                      </div>
                    </div>
