...
import { GlassCard, SparkleButton, ModeToggle, GlowEllipse, TradingCalendar, PeriodPill, Badge, StatCard } from '@/components/ui'
  ...
  return (
    <div className="pamm-details-page relative px-4 xl:px-5 2xl:px-7 3xl:px-10 4xl:px-14 py-4 4xl:py-6">
      ...
      <div className="flex flex-col gap-6 mt-6 3xl:mt-8 4xl:mt-10">
        ...
        {/* Header */}
        <ProfileHeader
          onBack={() => navigate('/gensocial/pamm')}
          backLabel="Back to PAMM"
          initials="BK"
          name="Bitcoin King"
          badges={
            <>
          ...
          onCtaClick={() => setConnectModalOpen(true)}
        />
