          ...
          <>
            ...
            <GlassBannerCard>
              <div className="flex items-center justify-between gap-8">
                ...
                <div className="hidden xl:flex items-center gap-5 bg-[#09241C] rounded-[1.875rem] px-5 py-5 shrink-0" style={{ minWidth: '22.4rem', minHeight: '8.375rem' }}>
                  <div className="w-[6.125rem] h-[6.125rem] rounded-[0.78rem] bg-[#064B34] flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <p className="text-white text-[3.125rem] font-acid leading-none">71</p>
                    <p className="text-[#808080] text-[1rem] font-acid font-medium leading-[1.5rem] mt-1">Active strategies</p>
                  </div>
                </div>
              </div>
            </GlassBannerCard>
