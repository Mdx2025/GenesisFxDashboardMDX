...
function LearningJourneyCard() {
  ...
  return (
    <GlassCard variant="heavy" divider="white" rounded="20px" className="w-full">
      <div className="relative z-10 overflow-hidden">
        <div className="absolute w-[717px] h-[727px] -right-[10%] -top-[250px] rounded-full [filter:url(#blur-157)] pointer-events-none bg-[#003523] opacity-40" aria-hidden="true" />
        <div className="absolute w-[493px] h-[278px] -left-[5%] -top-[100px] rounded-full [filter:url(#blur-157)] pointer-events-none bg-[#104030]" aria-hidden="true" />

        <div className="relative z-10 flex flex-col xl:flex-row items-start xl:items-center gap-6 3xl:gap-10 p-6 sm:p-8 3xl:p-10 4xl:p-14">
          <div className="flex-1 min-w-0 flex flex-col gap-5 3xl:gap-7 4xl:gap-9">
            <div className="flex items-center gap-4 3xl:gap-5 4xl:gap-7">
            ...
            <div className="flex flex-col gap-3 3xl:gap-4">
              <div className="w-full max-w-[492px] 3xl:max-w-[615px] 4xl:max-w-[740px] h-1 3xl:h-1.5 bg-[#0f1e19] rounded-full overflow-hidden">
                <div
              ...
              <div className="flex items-center gap-5 3xl:gap-7 4xl:gap-9 flex-wrap">
                ...
                <span className="text-white text-body2 font-medium">{pct}%</span>
              </div>
            </div>
          </div>

          <div className="hidden xl:block w-[200px] 3xl:w-[260px] 4xl:w-[320px] h-[180px] 3xl:h-[220px] 4xl:h-[280px] relative shrink-0 overflow-hidden rounded-2xl opacity-30">
            <img src="/images/pixels.png" alt="" className="w-full h-full object-cover" aria-hidden="true" />
          </div>
        </div>
      </div>
    </GlassCard>
