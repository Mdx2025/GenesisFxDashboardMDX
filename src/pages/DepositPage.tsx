                      ...
                      <div className="mt-4 max-w-[34.125rem]">
                        <GlassCard rounded="20px">
                          ...
                          <div className="relative z-10 p-5 flex flex-col sm:flex-row gap-5">
                            ...
                            <div className="flex-1 min-w-0">
                              <span className="text-sm 3xl:text-lg 4xl:text-2xl text-gfx-neutral-300 leading-[1.175rem] 3xl:leading-[1.5rem] 4xl:leading-[2rem]">Address</span>
                              ...
                              <p className="text-sm 3xl:text-lg 4xl:text-2xl text-gfx-neutral-300 leading-[1.175rem] 3xl:leading-[1.5rem] 4xl:leading-[2rem] mt-3">
