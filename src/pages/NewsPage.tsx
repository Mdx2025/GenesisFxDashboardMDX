        ...
        {webcams.map(cam => (
          <div key={cam.id} className="relative p-3 rounded-[10px] bg-[#04100A] border border-[rgba(94,255,169,0.10)] overflow-hidden flex flex-col gap-[89px]">
            ...
            <div className="relative z-10 flex items-center gap-2">
              ...
              <svg width="21" height="9" viewBox="0 0 21 9" fill="none" className="absolute left-[6px] top-[12px]">
            ...
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" className="absolute top-3 right-3 z-10">
