        ...
        <div className="shrink-0 border-t border-[#303030] bg-[#0c1311] px-4 xl:px-5 2xl:px-7 3xl:px-10 4xl:px-14">
          <div className="flex items-center justify-between h-[88px] gap-4">
            <button
              ...
              className="flex items-center gap-2 text-[#a0a0a0] hover:text-white transition-colors cursor-pointer shrink-0"
            >
              <ChevronLeftIcon />
              <span className="text-[16px] font-acid leading-[24.44px]">Previous</span>
            </button>
