  ...
  return (
    <div className="flex w-full min-h-screen bg-gfx-main text-white font-acid">
      ...
      <main className="flex-1 min-w-0 h-screen overflow-y-auto overflow-x-hidden relative">
        <div className="absolute left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full pointer-events-none" style={{ top: '-30%', background: '#104030', filter: 'blur(157px)', willChange: 'transform' }} aria-hidden="true" />
