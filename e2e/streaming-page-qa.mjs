...
if (!homeRefinement.featuredSurface.usesLightGlassCard || homeRefinement.featuredSurface.overlayRadius !== '9999px' || homeRefinement.featuredSurface.overlayBorderWidth !== '0px' || homeRefinement.featuredSurface.overlayBackdropFilter === 'none' || Math.abs(homeRefinement.featuredSurface.overlay?.height - 111) > 1) failures.push(`featured stream glass mismatch: ${JSON.stringify(homeRefinement.featuredSurface)}`)
