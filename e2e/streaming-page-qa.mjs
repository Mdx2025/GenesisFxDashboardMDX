...
console.log(JSON.stringify({ status: failures.length ? 'FAIL' : 'PASS', baseUrl, states, homeRefinement, carouselTransformBefore, carouselTransformAfterDrag, carouselTransformAfter, emptyVisible, browseAfterEmpty, lightSurface, zoomEquivalentOverflow, mobileOverflow, mobileTabsVisible, reducedMotionContentVisible, sendButtonFocused, runtimeErrors, failedResponses, failures }, null, 2))
await browser.close()
