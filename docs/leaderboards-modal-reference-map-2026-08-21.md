...
- Citation: `genesis-leaderboards-figma-full.png`, `genesis-leaderboards-figma-modal.png`.
...
- Citation: `genesis-leaderboards-figma-modal.png`.
...
- `genesis-leaderboards-figma-modal.png`: `755×551px` dark opaque shell with a thin teal outline, low green glow, and small top-right close control.
- `genesis-leaderboards-figma-modal.png`: 73px teal `@` identity tile aligned with the 36px heading and two-line unlock explanation.
- `genesis-leaderboards-figma-modal.png`: 562px green-outline username field followed by the 561px pale primary pill and teal availability state.
